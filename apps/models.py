...
class Apps(models.Model):
    app_name = models.CharField("Название приложения", max_length=255, unique=True)
    ...
    last_update = models.CharField("Обновление приложения", max_length=50, null=False, default='Не существует')